...
* What is the probability that you draw a *spade* ***given*** that you draw a *face card*?
    ...
    *Pr*(***spade*** ⋂ ***face card***) ÷ *Pr*(***face card***) = .058 / .231 = .25
    
    So, the probability that you draw a *spade* ***given*** that you draw a *face card* is .25 or 25%
    
    *This makes sense! If you know that the card drawn is a face card, there is still a 25% chance that the card
    is a spade, since there are the same number of face cards in each of the four suites of cards (e.g.

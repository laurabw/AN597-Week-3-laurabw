...
comment: I got the same but did it a little different.
...
Comment:Again, different method but same result!
...
Comment: Stats is hard, I have been doing it for years and I still have to remind myself what a poisson distribution is.
...
Comment: dpois generates a distribution consistant with poisson. ppois is for probability using poison distribution.
...
Comment: had to do a little googling myself. if you dont do this often it is hard to remember.
...
Comment: I feel confident about your answer to #2 but for #3, your guess is as good as mine.
...
Comment: You got this girl! Great job!
